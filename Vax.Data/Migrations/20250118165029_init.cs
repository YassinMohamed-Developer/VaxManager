        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VaccineCenters_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityAvalible = table.Column<int>(type: "int", nullable: false),
                    ...
                    VaccineCenterId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vaccines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Vaccines_VaccineCenters_VaccineCenterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reservations_VaccineCenters_VaccineCenterId",
                        column: x => x.VaccineCenterId,
                        principalTable: "VaccineCenters",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_VaccineCenterId",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VaccineCenters_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vaccines_VaccineCenterId",
                table: "Vaccines",
                column: "VaccineCenterId");
        }
